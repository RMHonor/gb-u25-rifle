<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/php/newsContentLoader.php') ?>
...
<head>
	...
	<meta property="og:url" content="http://www.gbu25rifleteam.co.uk/news/<?php echo $id ?>"/>
	<meta property="og:site_name" content="Great Britain U25 Rifle Team"/>
	<meta property="og:description" content="<?php echo $article->title ?>"/>
	...
	<link href="/css/history.css" rel="stylesheet" type="text/css" defer>
</head>
<body>
